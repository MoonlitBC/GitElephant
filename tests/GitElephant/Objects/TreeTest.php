...
class TreeTest extends TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $treeObj1 = $tree[0];
        $this->assertEquals(GitObject::TYPE_TREE, $treeObj1->getType());
        $treeObj2 = $tree[1];
        $this->assertEquals(GitObject::TYPE_BLOB, $treeObj2->getType());
    }
    ...
    public function testWithPath()
    {
        ...
        $this->assertCount(3, $tree);
        $treeObjChild = $tree[0];
        $this->assertEquals(GitObject::TYPE_TREE, $treeObjChild->getType());
    ...
    public function testSubmodule()
    {
        ...
        $submodule = $tree[0];
        $this->assertEquals(GitObject::TYPE_LINK, $submodule->getType());
    }
    ...
    public function testGetObject()
    {
        ...
        $this->assertEquals(GitObject::TYPE_TREE, $tree->getObject()->getType());
        $tree = $this->getRepository()->getTree('HEAD', 'test/1');
        $this->assertEquals(GitObject::TYPE_BLOB, $tree->getObject()->getType());
    }
}
